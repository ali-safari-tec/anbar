...
{
    /// <summary>
    /// Interaction logic for PriceListM1.xaml
    /// </summary>
    public partial class PriceListM1 : UserControl
    {
        ...
        private async void Load()
        {
            ...
            {
                var context = new GenericDataBaseServices<ListM1>(db);
                var existingRecord = await db.listM1s.FirstOrDefaultAsync(x => x.ListM1Id == 1);
                if (existingRecord != null)
                {
                    var update = await context.GetId(1);

                    p11.Text = update.M1P11.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p12.Text = update.M1P12.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p14.Text = update.M1P14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    pm14.Text = update.M1PM14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    pm16.Text = update.M1PM16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    pm18.Text = update.M1PM18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    po18.Text = update.M1PO18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    po19.Text = update.M1PO19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    a8.Text = update.M1G11.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    b8.Text = update.M1G12.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    c8.Text = update.M1G14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d8.Text = update.M1GM14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    e8.Text = update.M1GM16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    f8.Text = update.M1GM18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    g8.Text = update.M1GO18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    h8.Text = update.M1GO19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d.Text = update.M1day.ToString("00");
                    m.Text = update.M1month.ToString("00");
                    y.Text = update.M1year.ToString();
                }
                else
                {
                    ...
                    ListM1 listM1 = new ListM1()
                    {
                        ...
                        M1GO18 = 0,
                        M1GO19 = 0,
                        M1day = persianCalendar.GetDayOfMonth(now),
                        M1month = persianCalendar.GetMonth(now),
                        M1year = persianCalendar.GetYear(now)
                    };

                    await context.Create(listM1);

                    p11.Text = listM1.M1P11.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p12.Text = listM1.M1P12.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p14.Text = listM1.M1P14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    pm14.Text = listM1.M1PM14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    pm16.Text = listM1.M1PM16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    pm18.Text = listM1.M1PM18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    po18.Text = listM1.M1PO18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    po19.Text = listM1.M1PO19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    a8.Text = listM1.M1G11.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    b8.Text = listM1.M1G12.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    c8.Text = listM1.M1G14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d8.Text = listM1.M1GM14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    e8.Text = listM1.M1GM16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    f8.Text = listM1.M1GM18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    g8.Text = listM1.M1GO18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    h8.Text = listM1.M1GO19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d.Text = listM1.M1day.ToString("00");
                    m.Text = listM1.M1month.ToString("00");
                    y.Text = listM1.M1year.ToString();
                }
            }
        }
        ...
        private async void save_Click(object sender, RoutedEventArgs e)
        {
            ...
            using (var db = new DataBaseContext())
            {
                ...
                update.M1P11 = decimal.Parse(p11.Text);
                update.M1P12 = decimal.Parse(p12.Text);
                update.M1P14 = decimal.Parse(p14.Text);
                update.M1PM14 = decimal.Parse(pm14.Text);
                update.M1PM16 = decimal.Parse(pm16.Text);
                update.M1PM18 = decimal.Parse(pm18.Text);
                update.M1PO18 = decimal.Parse(po18.Text);
                update.M1PO19 = decimal.Parse(po19.Text);
                update.M1G11 = decimal.Parse(a8.Text);
                update.M1G12 = decimal.Parse(b8.Text);
                update.M1G14 = decimal.Parse(c8.Text);
                update.M1GM14 = decimal.Parse(d8.Text);
                update.M1GM16 = decimal.Parse(e8.Text);
                update.M1GM18 = decimal.Parse(f8.Text);
                update.M1GO18 = decimal.Parse(g8.Text);
                update.M1GO19 = decimal.Parse(h8.Text);
                update.M1day = int.Parse(d.Text);
                update.M1month = int.Parse(m.Text);
                update.M1year = int.Parse(y.Text);
