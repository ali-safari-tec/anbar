...
{
    /// <summary>
    /// Interaction logic for PriceListM.xaml
    /// </summary>
    public partial class PriceListM : UserControl
    {
        public FontSizeViewModel ViewModel { get; set; } = new FontSizeViewModel();
        ...
        private async void Load()
        {
            ...
            {
                var context = new GenericDataBaseServices<ListM>(db);
                var existingRecord = await db.listMs.FirstOrDefaultAsync(x => x.ListMId == 1);
                if (existingRecord != null)
                {
                    var update = await context.GetId(1);

                    p14.Text = update.MP14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p16.Text = update.MP16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p18.Text = update.MP18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p19.Text = update.MP19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p20.Text = update.MP20.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p22.Text = update.MP22.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p24.Text = update.MP24.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p27.Text = update.MP27.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p28.Text = update.MP28.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p30.Text = update.MP30.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p32.Text = update.MP32.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    a10.Text = update.MG14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    b10.Text = update.MG16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    c10.Text = update.MG18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d10.Text = update.MG19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    e10.Text = update.MG20.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    f10.Text = update.MG22.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    g10.Text = update.MG24.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    h10.Text = update.MG27.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    i10.Text = update.MG28.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    j10.Text = update.MG30.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    k10.Text = update.MG32.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d.Text = update.Mday.ToString("00");
                    m.Text = update.Mmonth.ToString("00");
                    y.Text = update.Myear.ToString();
                }
                else
                {
                    ...
                    ListM listM = new ListM()
                    {
                        ...
                        MG30 = 0,
                        MG32 = 0,
                        Mday = persianCalendar.GetDayOfMonth(now),
                        Mmonth = persianCalendar.GetMonth(now),
                        Myear = persianCalendar.GetYear(now)
                    };
                    await context.Create(listM);

                    p14.Text = listM.MP14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p16.Text = listM.MP16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p18.Text = listM.MP18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p19.Text = listM.MP19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p20.Text = listM.MP20.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p22.Text = listM.MP22.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p24.Text = listM.MP24.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p27.Text = listM.MP27.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p28.Text = listM.MP28.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p30.Text = listM.MP30.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    p32.Text = listM.MP32.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    a10.Text = listM.MG14.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    b10.Text = listM.MG16.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    c10.Text = listM.MG18.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d10.Text = listM.MG19.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    e10.Text = listM.MG20.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    f10.Text = listM.MG22.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    g10.Text = listM.MG24.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    h10.Text = listM.MG27.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    i10.Text = listM.MG28.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    j10.Text = listM.MG30.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    k10.Text = listM.MG32.ToString("N0", new System.Globalization.CultureInfo("fa-IR"));
                    d.Text = listM.Mday.ToString("00");
                    m.Text = listM.Mmonth.ToString("00");
                    y.Text = listM.Myear.ToString();
                }
            }
        }
        ...
        private async void save_Click(object sender, RoutedEventArgs e)
        {
            using (var db = new DataBaseContext())
            {
                ...
                update.MP14 = decimal.Parse(p14.Text);
                update.MP16 = decimal.Parse(p16.Text);
                update.MP18 = decimal.Parse(p18.Text);
                update.MP19 = decimal.Parse(p19.Text);
                update.MP20 = decimal.Parse(p20.Text);
                update.MP22 = decimal.Parse(p22.Text);
                update.MP24 = decimal.Parse(p24.Text);
                update.MP27 = decimal.Parse(p27.Text);
                update.MP28 = decimal.Parse(p28.Text);
                update.MP30 = decimal.Parse(p30.Text);
                update.MP32 = decimal.Parse(p32.Text);
                update.MG14 = decimal.Parse(a10.Text);
                update.MG16 = decimal.Parse(b10.Text);
                update.MG18 = decimal.Parse(c10.Text);
                update.MG19 = decimal.Parse(d10.Text);
                update.MG20 = decimal.Parse(e10.Text);
                update.MG22 = decimal.Parse(f10.Text);
                update.MG24 = decimal.Parse(g10.Text);
                update.MG27 = decimal.Parse(h10.Text);
                update.MG28 = decimal.Parse(i10.Text);
                update.MG30 = decimal.Parse(j10.Text);
                update.MG32 = decimal.Parse(k10.Text);
                update.Mday = int.Parse(d.Text);
                update.Mmonth = int.Parse(m.Text);
                update.Myear = int.Parse(y.Text);
